...
- [NodeJS][node] `>=18` (React 19 requires a modern Node)
...
This starts the [Vite](https://vite.dev/) dev server (typically at
`http://localhost:5173/`). The app runs on React 19.
...
- `src/exercise/00.jsx`: Exercise with Emoji helpers
- `src/__tests__/00.jsx`: Tests
- `src/final/00.jsx`: Final version
- `src/final/00.extra-0.jsx`: Final version of extra credit
